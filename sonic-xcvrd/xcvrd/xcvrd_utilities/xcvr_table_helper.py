...
TRANSCEIVER_STATUS_FLAG_SET_TIME = 'TRANSCEIVER_STATUS_FLAG_SET_TIME'
TRANSCEIVER_STATUS_FLAG_CLEAR_TIME = 'TRANSCEIVER_STATUS_FLAG_CLEAR_TIME'
...
class XcvrTableHelper:
    def __init__(self, namespaces):
        ...
        for namespace in namespaces:
            ...
            self.status_flag_change_count_tbl[asic_id] = swsscommon.Table(self.state_db[asic_id], TRANSCEIVER_STATUS_FLAG_CHANGE_COUNT)
            self.status_flag_set_time_tbl[asic_id] = swsscommon.Table(self.state_db[asic_id], TRANSCEIVER_STATUS_FLAG_SET_TIME)
            self.status_flag_clear_time_tbl[asic_id] = swsscommon.Table(self.state_db[asic_id], TRANSCEIVER_STATUS_FLAG_CLEAR_TIME)
